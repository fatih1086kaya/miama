...
rclone copy 6:yedek3 9:yedek3 --drive-chunk-size 1024M --no-traverse --checkers 3 --tpslimit 3 --transfers 3 --fast-list --drive-server-side-across-configs --ignore-existing -P;
index=$(($index + 1))
