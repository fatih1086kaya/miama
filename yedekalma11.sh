...
rclone copy 4:yedek1/ 7:yedek1/ --max-transfer 506G  --drive-chunk-size 1024M --no-traverse --checkers 30 --tpslimit 30 --transfers 1 --fast-list --drive-server-side-across-configs --ignore-existing -P ;
index=$(($index + 1))
