...
rclone copy 1:temp1 4:yedek1 --drive-chunk-size 1024M --no-traverse --checkers 3 --tpslimit 3 --transfers 3 --fast-list --drive-server-side-across-configs --ignore-existing -P;
index=$(($index + 1))
