...
rclone copy 2:temp2 5:yedek2 --drive-chunk-size 1024M --no-traverse --checkers 3 --tpslimit 3 --transfers 3 --fast-list --drive-server-side-across-configs --ignore-existing -P;
index=$(($index + 1))
