...
rclone move /data1/plot/ 3:temp3 --drive-chunk-size 1024M --no-traverse --min-size 101G --checkers 3 --tpslimit 3 --transfers 3 --fast-list --drive-server-side-across-configs -P;
index=$(($index + 1))
