...
rclone copy 3:temp3 6:yedek3 --drive-chunk-size 1024M --no-traverse --checkers 3 --tpslimit 3 --transfers 3 --fast-list --drive-server-side-across-configs --ignore-existing -P;
index=$(($index + 1))
